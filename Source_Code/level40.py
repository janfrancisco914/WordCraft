...
level = Label(          root, text="Level 40",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="An act of reading or reviewing", font=("", 25),                                              bg="#cce9f8")
