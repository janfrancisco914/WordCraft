...
# Content
level = Label(          root, text="Level 30",                                           font=("", 35),  height=4)
...
question = Label(       root, text="Any quick succession of meaningless sounds", font=("", 25))
...
e = Button(root, text="G", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("G"))
