...
# Content
level = Label(          root, text="Level 4",                                           font=("", 35),  height=4)
...
question = Label(       root, text="To charge with the fault", font=("", 25))
...
a = Button(root, text="U", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("U"))
