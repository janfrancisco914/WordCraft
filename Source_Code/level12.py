...
level = Label(          root, text="Level 12",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="Felt weak, dizzy, or exhausted", font=("", 25),                                              bg="#cce9f8")
