...
# Content
level = Label(          root, text="Level 5",                                           font=("", 35),  height=4)
...
question = Label(       root, text="To announce or proclaim with enthusiastic approval", font=("", 25))
...
m = Button(root, text="C", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("C"))
...
y = Button(root, text="M", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("M"))
