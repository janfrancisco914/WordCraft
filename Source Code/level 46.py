...
# Content
level = Label(          root, text="Level 46",                                           font=("", 35),  height=4)
...
question = Label(       root, text="Covering with a clay used in making molds \n for founding and in plastering walls", font=("", 25))
...
e = Button(root, text="L", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("L"))
m = Button(root, text="O", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("O"))
p = Button(root, text="A", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("A"))
a = Button(root, text="M", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("M"))
t = Button(root, text="I", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("I"))
h = Button(root, text="N", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("N"))
y = Button(root, text="G", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("G"))
