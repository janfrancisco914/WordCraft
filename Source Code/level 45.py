...
# Content
level = Label(          root, text="Level 45",                                           font=("", 35),  height=4)
...
question = Label(       root, text="Feels unwilling or reluctant", font=("", 25))
...
t = Button(root, text="H", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("H"))
