...
# Content
level = Label(          root, text="Level 80",                                           font=("", 35),  height=4)
...
question = Label(       root, text="Scent or odor that smell agreeable", font=("", 25))
...
a = Button(root, text="F", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("F"))
t = Button(root, text="U", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("U"))
h = Button(root, text="M", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("M"))
