...
level = Label(          root, text="Level 11",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="Based on or restricted to facts", font=("", 25),                                              bg="#cce9f8")
...
t = Button(root, text="U", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("U"))
