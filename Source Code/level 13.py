...
# Content
level = Label(          root, text="Level 13",                                           font=("", 35),  height=4)
...
question = Label(       root, text="Anything built or serving to bar passage \n as a railing, fence, or the like", font=("", 25))
...
e = Button(root, text="B", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("B"))
