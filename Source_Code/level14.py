...
level = Label(          root, text="Level 14",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="In a way that shows a lack of experience", font=("", 25),                                              bg="#cce9f8")
...
a = Button(root, text="V", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("V"))
