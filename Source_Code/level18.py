...
level = Label(          root, text="Level 18",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="A person who manufactures, repairs, \n or services firearms", font=("", 25),                                              bg="#cce9f8")
...
m = Button(root, text="R", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("R"))
p = Button(root, text="M", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("M"))
a = Button(root, text="O", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("O"))
t = Button(root, text="R", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("R"))
h = Button(root, text="E", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("E"))
y = Button(root, text="R", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("R"))
