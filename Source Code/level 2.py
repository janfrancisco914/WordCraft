...
question = Label(       root, text="Discrimination against disabled people", font=("", 25))
...
m = Button(root, text="B", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("B"))
