...
level = Label(          root, text="Level 36",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="Burdensome or troublesome", font=("", 25),                                              bg="#cce9f8")
...
e = Button(root, text="O", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("O"))
