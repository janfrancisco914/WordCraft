...
# Content
level = Label(          root, text="Level 132",                                           font=("", 35),  height=4)
...
question = Label(       root, text="A person with strong desire for something", font=("", 25))
...
a = Button(root, text="R", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("R"))
t = Button(root, text="N", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("N"))
