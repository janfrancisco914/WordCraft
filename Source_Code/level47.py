...
level = Label(          root, text="Level 47",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="A person with strong desire for something", font=("", 25),                                              bg="#cce9f8")
...
e = Button(root, text="Y", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("Y"))
m = Button(root, text="E", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("E"))
p = Button(root, text="A", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("A"))
a = Button(root, text="R", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("R"))
t = Button(root, text="N", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("N"))
