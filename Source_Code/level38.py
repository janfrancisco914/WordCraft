...
level = Label(          root, text="Level 38",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="A statement contrary to commonly \n accepted opinion", font=("", 25),                                              bg="#cce9f8")
...
t = Button(root, text="D", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("D"))
h = Button(root, text="O", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("O"))
y = Button(root, text="X", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("X"))
