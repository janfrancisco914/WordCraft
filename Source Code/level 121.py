...
# Content
level = Label(          root, text="Level 121",                                           font=("", 35),  height=4)
...
question = Label(       root, text="Increased in size as by hiring additional employees", font=("", 25))
...
e = Button(root, text="U", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("U"))
m = Button(root, text="P", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("P"))
...
t = Button(root, text="Z", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("Z"))
