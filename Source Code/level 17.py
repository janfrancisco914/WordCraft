...
# Content
level = Label(          root, text="Level 17",                                           font=("", 35),  height=4)
...
question = Label(       root, text="Law money to be paid as compensation to a person \n  for injury, loss, etc.", font=("", 25))
...
e = Button(root, text="D", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("D"))
