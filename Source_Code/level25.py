...
level = Label(          root, text="Level 25",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="An ability, natural, or acquired, \n for a particular kind of action", font=("", 25),                                              bg="#cce9f8")
