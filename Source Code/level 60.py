...
# Content
level = Label(          root, text="Level 60",                                           font=("", 35),  height=4)
...
question = Label(       root, text="Something that a person cannot conquer or achieve", font=("", 25))
...
e = Button(root, text="N", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("N"))
...
a = Button(root, text="I", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("E"))
t = Button(root, text="S", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("S"))
h = Button(root, text="I", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("I"))
