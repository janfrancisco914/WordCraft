...
level = Label(          root, text="Level 10",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="Law money to be paid as compensation \n to a person for injury, loss, etc", font=("", 25),                                              bg="#cce9f8")
...
t = Button(root, text="G", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("G"))
