...
# Content
level = Label(          root, text="Level 130",                                           font=("", 35),  height=4)
...
question = Label(       root, text="Trembled or moved with irregular rocking", font=("", 25))
...
e = Button(root, text="W", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("W"))
