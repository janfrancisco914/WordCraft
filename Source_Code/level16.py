...
level = Label(          root, text="Level 16",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="Characterized by the absence of life \n or living organisms", font=("", 25),                                              bg="#cce9f8")
...
e = Button(root, text="A", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("A"))
m = Button(root, text="B", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("B"))
p = Button(root, text="I", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("I"))
a = Button(root, text="O", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("O"))
t = Button(root, text="T", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("T"))
h = Button(root, text="I", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("I"))
y = Button(root, text="C", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("C"))
