...
# Content
level = Label(          root, text="Level 18",                                           font=("", 35),  height=4)
...
question = Label(       root, text="A person who owns or runs a dairy farm or dairy", font=("", 25))
...
t = Button(root, text="Y", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("Y"))
