...
level = Label(          root, text="Level 31",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="A person who owns or runs a dairy farm \n or dairy", font=("", 25),                                              bg="#cce9f8")
...
e = Button(root, text="D", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("D"))
...
t = Button(root, text="Y", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("Y"))
