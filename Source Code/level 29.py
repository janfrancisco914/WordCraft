...
# Content
level = Label(          root, text="Level 29",                                           font=("", 35),  height=4)
...
question = Label(       root, text="To pass time in idleness", font=("", 25))
...
e = Button(root, text="F", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("F"))
...
a = Button(root, text="Z", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("Z"))
