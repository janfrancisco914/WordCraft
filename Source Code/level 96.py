...
# Content
level = Label(          root, text="Level 96",                                           font=("", 35),  height=4)
...
question = Label(       root, text="To free from confinement or obligation", font=("", 25))
...
p = Button(root, text="L", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("L"))
