...
# Content
level = Label(          root, text="Level 110",                                           font=("", 35),  height=4)
...
question = Label(       root, text="The bulb of a plant that is related to onion", font=("", 25))
...
e = Button(root, text="S", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("S"))
m = Button(root, text="H", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("H"))
...
t = Button(root, text="L", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("L"))
