...
# Content
level = Label(          root, text="Level 63",                                           font=("", 35),  height=4)
...
question = Label(       root, text="A polygon eight angles and eight sides", font=("", 25))
...
e = Button(root, text="O", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("O"))
...
a = Button(root, text="A", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("A"))
t = Button(root, text="G", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("G"))
