...
# Content
level = Label(          root, text="Level 94",                                           font=("", 35),  height=4)
...
question = Label(       root, text="To increase again the amount of money in circulation", font=("", 25))
...
p = Button(root, text="F", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("F"))
...
h = Button(root, text="T", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("T"))
