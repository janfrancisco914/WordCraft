...
level = Label(          root, text="Level 6",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="A series of lines that can be read \n by an optical scanner", font=("", 25),                                              bg="#cce9f8")
...
a = Button(root, text="C", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("C"))
t = Button(root, text="O", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("O"))
h = Button(root, text="D", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("D"))
