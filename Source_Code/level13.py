...
level = Label(          root, text="Level 13",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="An act or instance of failing", font=("", 25),                                              bg="#cce9f8")
