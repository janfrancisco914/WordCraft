...
# Content
level = Label(          root, text="Level 142",                                           font=("", 35),  height=4)
...
question = Label(       root, text="A computerized service that auto deducts from \n one’s account an amount to meet \n the payment due date", font=("", 25))
...
t = Button(root, text="P", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("P"))
h = Button(root, text="A", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("A"))
