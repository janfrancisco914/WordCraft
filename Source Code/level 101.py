...
# Content
level = Label(          root, text="Level 101",                                           font=("", 35),  height=4)
...
question = Label(       root, text="A tide that opposes another tide", font=("", 25))
...
m = Button(root, text="I", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("I"))
p = Button(root, text="P", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("P"))
a = Button(root, text="T", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("T"))
