...
level = Label(          root, text="Level 19",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="Any large, plain building in which \n many people are lodged", font=("", 25),                                              bg="#cce9f8")
...
h = Button(root, text="C", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("C"))
y = Button(root, text="K", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("K"))
