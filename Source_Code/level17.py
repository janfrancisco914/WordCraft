...
level = Label(          root, text="Level 17",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="To announce or proclaim with \n enthusiastic approval", font=("", 25),                                              bg="#cce9f8")
...
p = Button(root, text="C", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("C"))
...
y = Button(root, text="M", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("M"))
