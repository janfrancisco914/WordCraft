...
question = Label(       root, text="Clothing worn for sleeping", font=("", 25))
...
p = Button(root, text="J", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("J"))
