...
# Content
level = Label(          root, text="Level 86",                                           font=("", 35),  height=4)
...
question = Label(       root, text="Any group of four persons or things", font=("", 25))
...
e = Button(root, text="Q", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("Q"))
