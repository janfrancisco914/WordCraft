...
level = Label(          root, text="Level 22",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="A plug of soft, pliable material inserted into the \n opening of the outer ear, especially to keep \n out water or noise", font=("", 25),                                              bg="#cce9f8")
...
p = Button(root, text="R", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("R"))
a = Button(root, text="P", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("P"))
t = Button(root, text="L", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("L"))
