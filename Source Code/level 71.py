...
# Content
level = Label(          root, text="Level 71",                                           font=("", 35),  height=4)
...
question = Label(       root, text="An impressive public building or private residence", font=("", 25))
...
y = Button(root, text="O", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("O"))
