...
# Content
level = Label(          root, text="Level 74",                                           font=("", 35),  height=4)
...
question = Label(       root, text="A statement contrary to commonly accepted opinion", font=("", 25))
...
y = Button(root, text="X", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("X"))
