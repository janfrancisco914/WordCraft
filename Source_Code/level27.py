...
level = Label(          root, text="Level 27",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="A place where a person or thing \n is usually found", font=("", 25),                                              bg="#cce9f8")
...
e = Button(root, text="H", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("H"))
m = Button(root, text="A", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("A"))
p = Button(root, text="B", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("B"))
...
h = Button(root, text="A", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("A"))
