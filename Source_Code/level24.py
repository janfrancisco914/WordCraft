...
level = Label(          root, text="Level 24",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="To make less important by comparison", font=("", 25),                                              bg="#cce9f8")
