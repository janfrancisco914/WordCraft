...
level = Label(          root, text="Level 29",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="Ordinary", font=("", 25),                                              bg="#cce9f8")
...
e = Button(root, text="M", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("M"))
m = Button(root, text="U", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("U"))
p = Button(root, text="N", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("N"))
