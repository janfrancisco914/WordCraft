...
level = Label(          root, text="Level 28",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="A fossil footprint", font=("", 25),                                              bg="#cce9f8")
...
e = Button(root, text="I", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("I"))
...
a = Button(root, text="N", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("N"))
