...
# Content
level = Label(          root, text="Level 84",                                           font=("", 35),  height=4)
...
question = Label(       root, text="A digital audio or video file \n that can be downloaded from", font=("", 25))
...
e = Button(root, text="P", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("P"))
m = Button(root, text="O", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("O"))
p = Button(root, text="D", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("D"))
...
h = Button(root, text="S", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("S"))
