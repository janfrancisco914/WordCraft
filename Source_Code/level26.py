...
level = Label(          root, text="Level 26",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="One of the elements contributing to a \n particular result or situation", font=("", 25),                                              bg="#cce9f8")
...
h = Button(root, text="R", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("R"))
