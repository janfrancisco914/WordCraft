...
level = Label(          root, text="Level 30",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="Having the ability to laugh", font=("", 25),                                              bg="#cce9f8")
...
m = Button(root, text="I", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("I"))
p = Button(root, text="S", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("S"))
a = Button(root, text="I", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("I"))
t = Button(root, text="B", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("B"))
h = Button(root, text="L", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("L"))
