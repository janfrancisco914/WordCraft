...
# Content
level = Label(          root, text="Level 91",                                           font=("", 35),  height=4)
...
question = Label(       root, text="To change or put back to a new or former position", font=("", 25))
...
h = Button(root, text="G", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("G"))
y = Button(root, text="N", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("N"))
