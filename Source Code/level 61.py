...
# Content
level = Label(          root, text="Level 61",                                           font=("", 35),  height=4)
...
question = Label(       root, text="People employed to gather news as for newspaper", font=("", 25))
...
p = Button(root, text="W", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("W"))
a = Button(root, text="S", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("S"))
t = Button(root, text="M", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("M"))
