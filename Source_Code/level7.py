...
level = Label(          root, text="Level 7",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="A person trained in the making \n and serving of coffee drinks", font=("", 25),                                              bg="#cce9f8")
...
e = Button(root, text="B", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("B"))
...
y = Button(root, text="A", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("A"))
