...
# Content
level = Label(          root, text="Level 98",                                           font=("", 35),  height=4)
...
question = Label(       root, text="No longer occupied with one’s business or profession", font=("", 25))
...
e = Button(root, text="R", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("R"))
...
a = Button(root, text="I", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("I"))
...
y = Button(root, text="D", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("D"))
