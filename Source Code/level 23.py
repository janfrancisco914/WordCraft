...
# Content
level = Label(          root, text="Level 23",                                           font=("", 35),  height=4)
...
question = Label(       root, text="Relating to a story, novel, or the like \n written in the form of a fable", font=("", 25))
...
p = Button(root, text="B", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("B"))
