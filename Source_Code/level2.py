...
level = Label(          root, text="Level 2",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="Charges with the fault", font=("", 25),                                              bg="#cce9f8")
...
a = Button(root, text="U", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("U"))
