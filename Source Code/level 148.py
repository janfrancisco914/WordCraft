...
# Content
level = Label(          root, text="Level 148",                                           font=("", 35),  height=4)
...
question = Label(       root, text="People who exercise or try to \n exercise absolute authority", font=("", 25))
...
e = Button(root, text="K", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("K"))
