...
level = Label(          root, text="Level 35",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="Whole or complete", font=("", 25),                                              bg="#cce9f8")
...
a = Button(root, text="F", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("F"))
...
y = Button(root, text="D", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("D"))
