...
level = Label(          root, text="Level 15",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="A personal view", font=("", 25),                                              bg="#cce9f8")
...
m = Button(root, text="P", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("P"))
...
h = Button(root, text="O", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("O"))
y = Button(root, text="N", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("N"))
