...
# Content
level = Label(          root, text="Level 117",                                           font=("", 35),  height=4)
...
question = Label(       root, text="Not skilled or not proficient", font=("", 25))
...
a = Button(root, text="D", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("D"))
t = Button(root, text="E", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("E"))
