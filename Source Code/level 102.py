...
# Content
level = Label(          root, text="Level 102",                                           font=("", 35),  height=4)
...
question = Label(       root, text="Having the ability to laugh", font=("", 25))
...
t = Button(root, text="B", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("B"))
h = Button(root, text="L", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("L"))
