...
# Content
level = Label(          root, text="Level 59",                                           font=("", 35),  height=4)
...
question = Label(       root, text="Another term of disobedient and mischievous", font=("", 25))
...
p = Button(root, text="U", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("U"))
