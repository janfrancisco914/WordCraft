...
# Content
level = Label(          root, text="Level 11",                                           font=("", 35),  height=4)
...
question = Label(       root, text="Treating as a newborn", font=("", 25))
...
a = Button(root, text="Y", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("Y"))
