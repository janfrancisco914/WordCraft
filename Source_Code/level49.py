...
level = Label(          root, text="Level 49",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="Characterized by hearty enjoyment", font=("", 25),                                              bg="#cce9f8")
...
p = Button(root, text="S", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("S"))
a = Button(root, text="T", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("T"))
t = Button(root, text="F", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("F"))
h = Button(root, text="U", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("U"))
y = Button(root, text="L", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("L"))
