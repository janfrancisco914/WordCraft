...
# Content
level = Label(          root, text="Level 122",                                           font=("", 35),  height=4)
...
question = Label(       root, text="Lead, introduced, or conducted", font=("", 25))
...
m = Button(root, text="S", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("S"))
p = Button(root, text="H", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("H"))
