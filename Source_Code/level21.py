...
level = Label(          root, text="Level 21",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="In a way that shows keen interest or fervent, \n often impatient desire or feeling", font=("", 25),                                              bg="#cce9f8")
...
p = Button(root, text="G", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("G"))
