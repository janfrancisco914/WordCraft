...
level = Label(          root, text="Level 43",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="A tax paid by peasants to the lord \n of their manor", font=("", 25),                                              bg="#cce9f8")
...
e = Button(root, text="T", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("T"))
