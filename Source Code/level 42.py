...
# Content
level = Label(          root, text="Level 42",                                           font=("", 35),  height=4)
...
question = Label(       root, text="Designs or means for a particular purpose", font=("", 25))
...
a = Button(root, text="E", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("E"))
