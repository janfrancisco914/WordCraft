...
# Content
level = Label(          root, text="Level 107",                                           font=("", 35),  height=4)
...
question = Label(       root, text="Something that seeps or leaks out", font=("", 25))
...
p = Button(root, text="E", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("E"))
