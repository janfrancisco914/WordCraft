...
# Content
level = Label(          root, text="Level 51",                                           font=("", 35),  height=4)
...
question = Label(       root, text="Combine or uniting into a single enterprise", font=("", 25))
...
p = Button(root, text="R", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("R"))
a = Button(root, text="G", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("G"))
