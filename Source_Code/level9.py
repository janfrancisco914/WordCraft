...
level = Label(          root, text="Level 9",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="Duty on imports or exports", font=("", 25),                                              bg="#cce9f8")
...
e = Button(root, text="C", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("C"))
...
h = Button(root, text="M", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("M"))
