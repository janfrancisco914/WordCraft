...
# Content
level = Label(          root, text="Level 140",                                           font=("", 35),  height=4)
...
question = Label(       root, text="A person trained in the making and serving \n of coffee drinks", font=("", 25))
...
y = Button(root, text="A", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("A"))
