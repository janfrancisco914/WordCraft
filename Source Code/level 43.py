...
# Content
level = Label(          root, text="Level 43",                                           font=("", 35),  height=4)
...
question = Label(       root, text="Spoke angrily", font=("", 25))
...
e = Button(root, text="J", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("J"))
