...
# Content
level = Label(          root, text="Level 109",                                           font=("", 35),  height=4)
...
question = Label(       root, text="Not deep", font=("", 25))
...
y = Button(root, text="W", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("W"))
