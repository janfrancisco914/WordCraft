...
# Content
level = Label(          root, text="Level 36",                                           font=("", 35),  height=4)
...
question = Label(       root, text="Shock or dismay", font=("", 25))
...
h = Button(root, text="F", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("F"))
