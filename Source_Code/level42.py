...
level = Label(          root, text="Level 42",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="Something that seeps or leaks out", font=("", 25),                                              bg="#cce9f8")
...
e = Button(root, text="S", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("S"))
m = Button(root, text="E", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("E"))
p = Button(root, text="E", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("E"))
a = Button(root, text="P", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("P"))
