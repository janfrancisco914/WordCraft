...
level = Label(          root, text="Level 41",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="To increase again the amount \n of money in circulation", font=("", 25),                                              bg="#cce9f8")
...
e = Button(root, text="R", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("R"))
m = Button(root, text="E", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("E"))
p = Button(root, text="F", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("F"))
a = Button(root, text="L", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("L"))
t = Button(root, text="A", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("A"))
h = Button(root, text="T", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("T"))
y = Button(root, text="E", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("E"))
