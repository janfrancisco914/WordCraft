...
# Content
level = Label(          root, text="Level 137",                                           font=("", 35),  height=4)
...
question = Label(       root, text="Branch of science that deals with animals", font=("", 25))
...
e = Button(root, text="Z", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("Z"))
m = Button(root, text="O", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("O"))
p = Button(root, text="O", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("O"))
