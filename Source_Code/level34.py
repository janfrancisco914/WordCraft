...
level = Label(          root, text="Level 34",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="Something that a person cannot \n conquer or achieve", font=("", 25),                                              bg="#cce9f8")
...
e = Button(root, text="N", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("N"))
...
a = Button(root, text="E", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("E"))
t = Button(root, text="S", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("S"))
h = Button(root, text="I", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("I"))
y = Button(root, text="S", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("S"))
