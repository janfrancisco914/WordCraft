...
level = Label(          root, text="Level 50",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="Young city dwellers with affluent lifestyle", font=("", 25),                                              bg="#cce9f8")
...
p = Button(root, text="P", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("P"))
