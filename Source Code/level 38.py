...
# Content
level = Label(          root, text="Level 38",                                           font=("", 35),  height=4)
...
question = Label(       root, text="A person who refrains from noticing or recognizing", font=("", 25))
...
m = Button(root, text="G", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("G"))
