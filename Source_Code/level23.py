...
def submitValues():
    ...
    if entered == "ECHOING":
        ...
        Button(pop, text="To Hidden Quote", font=("", 17), bg="#38b6ff", fg="white" ,width=18, height=2, command=toQuotes).grid(row=4,column=1, pady=20)
        Button(pop, text="Next Level", font=("", 17), bg="#38b6ff", fg="white" ,width=18, height=2, command=nextLevel).grid(row=4, column=2, pady=20)
...
level = Label(          root, text="Level 23",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="A sound heard again near its source \n after being reflected", font=("", 25),                                              bg="#cce9f8")
...
e = Button(root, text="E", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("E"))
m = Button(root, text="C", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("C"))
p = Button(root, text="H", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("H"))
a = Button(root, text="O", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("O"))
t = Button(root, text="I", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("I"))
h = Button(root, text="N", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("N"))
y = Button(root, text="G", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("G"))
