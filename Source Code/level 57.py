...
# Content
level = Label(          root, text="Level 57",                                           font=("", 35),  height=4)
...
question = Label(       root, text="In a way that shows a lack of experience", font=("", 25))
...
a = Button(root, text="V", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("V"))
