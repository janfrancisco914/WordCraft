...
# Content
level = Label(          root, text="Level 35",                                           font=("", 35),  height=4)
...
question = Label(       root, text="Referring to two or more kinds of species", font=("", 25))
...
e = Button(root, text="H", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("H"))
