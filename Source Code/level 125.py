...
# Content
level = Label(          root, text="Level 125",                                           font=("", 35),  height=4)
...
question = Label(       root, text="To put to use", font=("", 25))
...
m = Button(root, text="T", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("T"))
...
h = Button(root, text="Z", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("Z"))
