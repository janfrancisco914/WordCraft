...
# Content
level = Label(          root, text="Level 44",                                           font=("", 35),  height=4)
...
question = Label(       root, text="Marked with a short word or phrase \n descriptive of a person, group, etc.", font=("", 25))
...
a = Button(root, text="A", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("E"))
