...
# Content
level = Label(          root, text="Level 99",                                           font=("", 35),  height=4)
...
question = Label(       root, text="To draw back or in", font=("", 25))
...
h = Button(root, text="C", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("C"))
