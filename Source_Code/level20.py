...
level = Label(          root, text="Level 20",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="An alternative, additional choice, or the like", font=("", 25),                                              bg="#cce9f8")
