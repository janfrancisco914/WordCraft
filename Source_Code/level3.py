...
level = Label(          root, text="Level 3",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="An analysis of something after it \n has been done or made", font=("", 25),                                              bg="#cce9f8")
...
m = Button(root, text="U", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("U"))
p = Button(root, text="T", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("T"))
a = Button(root, text="O", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("O"))
t = Button(root, text="P", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("P"))
h = Button(root, text="S", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("S"))
y = Button(root, text="Y", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("Y"))
