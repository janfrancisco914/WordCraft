...
# Content
level = Label(          root, text="Level 134",                                           font=("", 35),  height=4)
...
question = Label(       root, text="Young city dwellers with affluent lifestyle", font=("", 25))
...
m = Button(root, text="U", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("U"))
p = Button(root, text="P", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("P"))
a = Button(root, text="P", font=("Time", 15), fg="#F3F3F3", bg="#5b5b5b", height=2, width=5, command=lambda: click("P"))
