...
level = Label(          root, text="Level 32",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="To pass time in idleness", font=("", 25),                                              bg="#cce9f8")
...
e = Button(root, text="F", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("F"))
...
a = Button(root, text="Z", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("Z"))
