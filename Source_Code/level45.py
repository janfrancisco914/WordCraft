...
level = Label(          root, text="Level 45",                                           font=("", 35),  height=4,                                   bg="#ebf8ff")
...
question = Label(       root, text="Study of unidentified flying objects", font=("", 25),                                              bg="#cce9f8")
...
e = Button(root, text="U", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("U"))
m = Button(root, text="F", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("F"))
p = Button(root, text="O", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("O"))
a = Button(root, text="L", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("L"))
t = Button(root, text="O", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("O"))
h = Button(root, text="G", font=("Time", 15), fg="#F3F3F3", bg="#38b6ff", height=2, width=5, command=lambda: click("G"))
